      ...
      const saveRedirectPath = async () => {
        try {
          ...
          return new Promise<void>((resolve) => {
            ...
            // Méthode spécifique pour les appareils mobiles
            // Créer un cookie avec SameSite=None pour meilleure compatibilité mobile
            document.cookie = `redirectAfterLogin_mobile=${encodeURIComponent(redirectPath)}; path=/; max-age=3600; SameSite=None; Secure`;
            console.log('Cookie mobile mis à jour');
            
            // Méthode supplémentaire avec paramètre dans l'URL pour les redirections mobiles
            localStorage.setItem('mobile_redirect', redirectPath);
